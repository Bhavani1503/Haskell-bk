...
/* package Haskell-bk-0.1.0.0 */
#ifndef VERSION_Haskell_bk
#define VERSION_Haskell_bk "0.1.0.0"
#endif /* VERSION_Haskell_bk */
#ifndef MIN_VERSION_Haskell_bk
#define MIN_VERSION_Haskell_bk(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_bk */
...
#define CURRENT_COMPONENT_ID "Haskell-bk-0.1.0.0-inplace-Haskell-bk"
